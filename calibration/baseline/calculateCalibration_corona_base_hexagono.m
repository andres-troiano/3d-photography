function calculateCalibration_corona_base_hexagono(C,basepath)
...
% 	saveas(f4, [basepath 'figuras_calibracion\f4_cam_' num2str(q)])
    saveas(f4, [basepath 'figuras_calibracion_corona_hexagono/f4_cam_' num2str(q) '.png'])
...
%     saveas(f3, [basepath 'figuras_calibracion\f3_cam_' num2str(q)])
    saveas(f3, [basepath 'figuras_calibracion_corona_hexagono/f3_cam_' num2str(q) '.png'])
...
%     saveas(f2, [basepath 'figuras_calibracion\deltas_cam_' num2str(q)])
    saveas(f2, [basepath 'figuras_calibracion_corona_hexagono/deltas_cam_' num2str(q) '.png'])
...
%     saveas(f1, [basepath 'figuras_calibracion\used_points_cam_' num2str(q)])
    saveas(f1, [basepath 'figuras_calibracion_corona_hexagono/used_points_cam_' num2str(q) '.png'])

end

save(fullfile(basepath,'calibration_corona_base_hexagono.mat'),'px2mmPol')

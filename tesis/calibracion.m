...
for f = 1:3
    ...
    [centro_x, centro_y, r_teorico, r_individual, centro_individual] = mido_patron(frames_cilindro, id_cilindro{f}, px2mmPol, offset_fronteras, F, FC, [path_datos 'medicion\']); % con las fronteras en el offset

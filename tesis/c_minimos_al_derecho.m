function c_minimos_al_derecho(C,basepath)
...
%     saveas(f5, [basepath 'figuras_al_derecho/f5_cam_' num2str(q) '.png'])
...
%     saveas(f4, [basepath 'figuras_al_derecho/f4_cam_' num2str(q) '.png'])
...
%	Ymmfit=polyval4XY(px2mmPol{q}(2),Xpxfit1,Ypxfit1);
    ...
    saveas(f3, [basepath 'figuras_al_derecho/f3_cam_' num2str(q) '.png'])
...
% 	linkaxes([ax1 ax2],'x')
%     saveas(f2, [basepath 'figuras_al_derecho/deltas_cam_' num2str(q) '.png'])
...
% 	set(gca,'YDir','reverse')
%     saveas(f1, [basepath 'figuras_al_derecho/used_points_cam_' num2str(q) '.png'])

...
% yo creo que acá en realidad hay que usar la calibración sin fronteras,
% porque el output de esto lo necesito para calcular la calibracion CON
% fronteras. Por otro lado no va a haber grandes diferencias en las
% fronteras

function [centro_x, centro_y, r_teorico, r_individual, centro_individual] = mido_patron_con_hexagono(frames_cilindro, id_cilindro, px2mmPol, offset, F, FC, path_plot)
...
%         plot(F{q}(:,1), F{q}(:,2), mf{q})
        ...
        saveas(h2, [path_plot 'medicion_con_hexagono\'  id_cilindro '_error_C' num2str(q) '.png'])
        close(2)
...
%     XY = [XY{1}, XY{2}];
    ...
    saveas(h1, [path_plot 'medicion_con_hexagono\'  id_cilindro '_medicion.png'])
    ...
    saveas(h3, [path_plot 'medicion_con_hexagono\'  id_cilindro '_error_camaras_combinadas.png'])

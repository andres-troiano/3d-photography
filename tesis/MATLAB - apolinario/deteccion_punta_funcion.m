function [x_0, y_0] = deteccion_punta_funcion(filename)

% Necesito que esta función devuelva las coordenadas de la punta, en pixels

% filename = 'C:\Users\60069978\Documents\MATLAB\scan\frame_umbral_102_x_290_y_460.png';

    set(0,'DefaultFigureVisible','off');

    % esta funcion no devuelve nada, guarda una imagen
    
    frame = imread(filename);
    
    path = strsplit(filename, 'frame_');
    path = path{1};

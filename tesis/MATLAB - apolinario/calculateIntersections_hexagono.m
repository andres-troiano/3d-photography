function [] = calculateIntersections_hexagono(basepath)

% modificación de calculateIntersections. Guarda adicionalmente las rectas
% para calcular el ángulo de la esquina
    ...
    for q=1:2
        ...
        nfig=figure();plot(Profiles(:,km), '.-'),hold all,grid on,xlabel('Pixel X'),ylabel('Pixel Y'),axis equal,title({sprintf('x=%d, y=%d',X(km),Y(km)),'Elija la intersección aproximada o cierre la ventana'})
